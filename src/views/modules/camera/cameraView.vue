            ...
            <el-row>
              <el-col>
                <el-form-item label="IP地址">
                  <el-input v-model="hkvInfo.ip" placeholder="IP地址"></el-input>
                </el-form-item>
                <el-form-item label="端口号">
                  <el-input v-model="hkvInfo.port" placeholder="端口号"></el-input>
                </el-form-item>

                <el-form-item label="相机账户">
                  <el-input v-model="hkvInfo.username" placeholder="相机账户"></el-input>
                </el-form-item>
                <el-form-item label="相机密码">
                  <el-input v-model="hkvInfo.password" placeholder="相机密码"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
...
<script>
  import {WebVideoCtrl} from '../../../../static/plugins/hikvision/webVideoCtrl.js'
