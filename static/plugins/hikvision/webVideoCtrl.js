      ...
      var t = function () {
          ...
          var _ = function () {
            ...
            F = function () {
              var e = ''
              if (f.browser().msie) {
                e = '<object classid=\'' + a.szOcxClassId + '\' codebase=\'\' standby=\'Waiting...\' id=\'' + o + '\' width=\'' + r + '\' height=\'' + s + '\' align=\'center\' ><param name=\'wndtype\' value=\'' + a.iWndowType + '\'><param name=\'playmode\' value=\'' + a.iPlayMode + '\'><param name=\'colors\' value=\'' + a.szColorProperty + '\'></object>'
              } else {
                for (var t = navigator.mimeTypes.length,
                  n = 0; t > n; n++) {
                  navigator.mimeTypes[n].type.toLowerCase() == a.szMimeTypes && (e = '<embed align=\'center\' type=\'' + a.szMimeTypes + '\' width=\'' + r + '\' height=\'' + s + '\' name=\'' + i + '\' wndtype=\'' + a.iWndowType + '\' playmode=\'' + a.iPlayMode + '\' colors=\'' + a.szColorProperty + '\'>')
                }
              }
              return e
            },
            ...
            J = function (e) {
              ...
              if (ee(e)) {
                ...
                for (var o = Q(e), i = !1, a = 0; a < o.length; a++) {
            ...
            K = function (e) {
              ...
              return e.oProtocolInc.getPortInfo(e, {
                ...
                success: function (e) {
                  ...
                  for (var i = 0,
                    a = o.length; a > i; i++) {
                    'rtsp' === n.$XML(o).eq(i).find('protocol').eq(0).text().toLowerCase() && (t = parseInt(n.$XML(o).eq(i).find('portNo').eq(0).text(), 10)),
            ...
            Y = function (e) {
              ...
              return e.oProtocolInc.getUPnPPortStatus(e, {
                async: !1,
                success: function (e) {
                  for (var o = n.$XML(e).find('portStatus', !0), i = 0, a = o.length; a > i; i++) {
                    'rtsp' == n.$XML(o).eq(i).find('internalPort').eq(0).text().toLowerCase() && (t = parseInt(n.$XML(o).eq(i).find('externalPort').eq(0).text(), 10)),
          ...
          this.I_InitPlugin = function (t, n, o) {
            ...
            this.I_InsertOBJECTPlugin = function (t) {
              ...
              if (re()) {
                ...
                if ('' != u) {
                  for (var l = {},
                    d = u.split(';'), p = '', P = 0, h = d.length; h > P; P++) {
                    p = d[P],
                ...
                document.getElementById(a.szContainerID).innerHTML = F(),
          ...
          this.I_Login = function (t, r, s, o, i, a) {
            ...
            var l = h,
              p = S
            if (B(a.cgi) || (S == a.cgi ? (l = h, p = S) : (l = I, p = v)), re()) {
              if (S == p) {
                var P = {
                  success: null,
                  error: null
            ...
            this.I_StartRealPlay = function (e, t) {
              ...
              if (f.extend(P, t), -1 != r) {
                ...
                if (f.extend(P, {
                  ...
                  iStreamType: c,
                  iChannelID: a
                }), r = this.findWndIndexByIndex(P.iWndIndex), -1 == r) {
                  if (re()) {
                    h.oProtocolInc.startRealPlay(h, P).then(function () {
            ...
            this.I_Stop = function (e) {
              ...
              if (-1 != n) {
                var r = p[n]
                if (r.bRecord && (re() || c.HWP_StopSave(r.iIndex)), r.bSound && (re() || c.HWP_CloseSound()), r.bEZoom && (re() || c.HWP_DisableZoom(r.iIndex)), re()) {
                  c.JS_Stop(t.iWndIndex).then(function () {
                      p.splice(n, 1),
                      t.success && t.success()
                    },
                    function () {
            ...
            this.I_CapturePic = function (e, t) {
              ...
              if (-1 != r) {
                if (re()) {
                  ...
                  '.jpg' === e.slice(-4).toLowerCase() ? e = e.slice(0, -4) : '.jpeg' === e.slice(-5).toLowerCase() && (e = e.slice(0, -5)),
            ...
            this.I_StartPlayback = function (e, t) {
              ...
              if (f.extend(p, t), -1 != r) {
                ...
                if (f.extend(p, {
                  ...
                  if (re()) {
                    p.szStartTime = p.szStartTime.replace(' ', 'T') + 'Z',
            ...
            this.I_Frame = function (e) {
              ...
              if (-1 != n) {
                ...
                if (s == D || s == T) {
                  if (re()) {
                    c.JS_FrameForward(t.iWndIndex).then(function () {
                        r.iPlayStatus = T,
                        t.success && t.success()
                      },
                      function () {
            ...
            this.I_Pause = function (e) {
              ...
              if (-1 != n) {
                ...
                if (re()) {
                  c.JS_Pause(t.iWndIndex).then(function () {
                      r.iPlayStatus = o,
                      t.success && t.success()
                    },
                    function () {
            ...
            this.I_Resume = function (e) {
              ...
              if (-1 != n) {
                ...
                if (re()) {
                  c.JS_Resume(t.iWndIndex).then(function () {
                      r.iPlayStatus = o,
                      t.success && t.success()
                    },
                    function () {
            ...
            this.I_GetOSDTime = function (e) {
              ...
              if (-1 != n) {
                if (re()) {
                  c.JS_GetOSDTime(t.iWndIndex).then(function (e) {
                      if (t.success) {
            ...
            this.I_CheckPluginInstall = function () {
              ...
              if (re()) {
                ...
                for (var r = 0,
                  s = navigator.mimeTypes.length; s > r; r++) {
            ...
            this.I_RemoteConfig = function (e, t) {
              ...
              if (f.extend(o, t), -1 != n) {
                ...
                if (':' == f.Base64.decode(i.szAuth)[0]) {
                  var a = f.Base64.decode(i.szAuth).split(':')[1],
                    u = f.Base64.decode(i.szAuth).split(':')[2]
                } else {
                  var a = f.Base64.decode(i.szAuth).split(':')[0],
            ...
            this.findDeviceIndexByIP = function (e) {
              if (e.indexOf('_') > -1) {
                for (var t = 0,
                  n = d.length; n > t; t++) {
                  if (d[t].szDeviceIdentify == e) return t
                }
              } else {
                for (var t = 0,
                  n = d.length; n > t; t++) {
                  if (d[t].szIP == e) return t
                }
              }
              return -1
            },
          ...
          ue.prototype.m_httpRequestSet = [],
            ...
            ue.prototype.processCallback = function (e, t) {
              for (var n = null,
                r = 0; r < this.m_httpRequestSet.length; r++) {
          ...
          le.prototype.CGI = {
            ...
            le.prototype.getStreamChannels = function (e, t) {
              if (0 != e.iAnalogChannelNum) {
                var n = E(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort)
              } else {
                var n = E(this.CGI.getStreamChannels.digital, e.szHttpProtocol, e.szIP, e.iCGIPort)
              }
              var r = new ue,
                s = {
                  type: 'GET',
            ...
            le.prototype.ptzAutoControl = function (e, t, n, r) {
              var s = n.iChannelID,
                o = '',
                i = ''
              if (r.iPTZSpeed = r.iPTZSpeed < 7 ? 15 * r.iPTZSpeed : 100, t && (r.iPTZSpeed = 0), e.szDeviceType != w) {
                o = s <= e.iAnalogChannelNum ? E(this.CGI.ptzAutoControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID) : n.bShttpIPChannel ? E(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : E(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID),
            ...
            le.prototype.deviceCapturePic = function (e, t, n, r) {
              ...
              if (f.isInt(r.iResolutionWidth) && i.push('videoResolutionWidth=' + r.iResolutionWidth), f.isInt(r.iResolutionHeight) && i.push('videoResolutionHeight=' + r.iResolutionHeight), i.length > 0 && (o += '?' + i.join('&')), re()) {
                ...
                s = c.HWP_DeviceCapturePic(o, e.szAuth, n, r.bDateDir)
              }
              return s
            },
          ...
          de.prototype.CGI = {
            ...
            de.prototype.ptzAutoControl = function (e, t, n, r) {
              var s = n.iChannelID,
                ...
                i = ''
              if (r.iPTZSpeed = r.iPTZSpeed < 7 ? 15 * r.iPTZSpeed : 100, t && (r.iPTZSpeed = 0), e.szDeviceType != w) {
                o = E(this.CGI.ptzAutoControl, e.szHttpProtocol, e.szIP, e.iCGIPort, s),
                  i = '<?xml version=\'1.0\' encoding=\'UTF-8\'?><PTZData><pan>' + r.iPTZSpeed + '</pan><tilt>0</tilt></PTZData>'
              } else {
                var a = 99
                t && (a = 96),
          ...
          Pe.prototype.extend = function () {
            ...
            Pe.prototype.Base64 = {
              ...
              encode: function (e) {
                var t, n, r, s, o, i, a, c = '',
                  u = 0
                for (e = Pe.prototype.Base64._utf8_encode(e); u < e.length;) {
                  t = e.charCodeAt(u++),
                    n = e.charCodeAt(u++),
                    r = e.charCodeAt(u++),
                    s = t >> 2,
              ...
              return e = function (e) {
                ...
                function (e) {
                  ...
                  for (e[r >> 5] |= 128 << 24 - r % 32, e[(r + 64 >> 9 << 4) + 15] = r, p = 0; p < e.length; p += 16) {
                    for (s = m[0], o = m[1], i = m[2], a = m[3], c = m[4], u = m[5], l = m[6], d = m[7], P = 0; 64 > P; P++) {
                      C[P] = 16 > P ? e[P + p] : t(t(t(n(C[P - 2], 17) ^ n(C[P - 2], 19) ^ C[P - 2] >>> 10, C[P - 7]), n(C[P - 15], 7) ^ n(C[P - 15], 18) ^ C[P - 15] >>> 3), C[P - 16]),
